...
/**
 * Hành động cho mỗi row của table:
 *  - Desktop / tablet (≥481px): hiện tất cả buttons inline.
 *  - Mobile (≤480px): hiện 1 nút kebab (⋮), tap vào mở dropdown chứa các action.
 *  CSS quyết định mode hiển thị; component luôn render cả 2 để không phải listen resize.
 */
